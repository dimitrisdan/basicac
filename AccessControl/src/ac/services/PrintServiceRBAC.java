...
public class PrintServiceRBAC  {
	...
	public String print(String username,String filename, String printer) throws Exception{
		if (AuthenticationService.checkAuthority(username,"print"))
	...
	public String queue(String username) throws Exception{
		if (AuthenticationService.checkAuthority(username,"queue"))
			return queue();
		else
			throw new Exception("Access Denied");
	}
	...
	public Boolean topQueue(String username, int job) throws Exception{
		if (AuthenticationService.checkAuthority(username,"topqueue"))
			return topQueue(job);
		else
			throw new Exception("Access Denied");
	}
	...
	public Boolean start(String username) throws Exception{
		if (AuthenticationService.checkAuthority(username,"start"))
			return start();
		else
			throw new Exception("Access Denied");
	}
	...
	public Boolean stop(String username)throws Exception{
		if (AuthenticationService.checkAuthority(username,"stop"))
			return stop();
		else
			throw new Exception("Access Denied");
	}
	...
	public Boolean restart(String username)throws Exception{
		if (AuthenticationService.checkAuthority(username,"restart"))
			return restart();
		else
			throw new Exception("Access Denied");
	}
	...
	public String status(String username)throws Exception{
		if (AuthenticationService.checkAuthority(username,"status"))
			return status();
		else
			throw new Exception("Access Denied");
	}
	...
	public String readConfig(String username, String parameter)throws Exception{
		if (AuthenticationService.checkAuthority(username,"readconfig"))
	...
	public Boolean setConfig(String username, String parameter, String value)throws Exception{
		if (AuthenticationService.checkAuthority(username,"setconfig"))
