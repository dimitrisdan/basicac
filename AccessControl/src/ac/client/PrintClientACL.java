...
import ac.services.PrintServiceACL;

public class PrintClientACL {
			...
			try {
				...
				do{
					...
					if(rmt.validateUser(username,readPassword(username))){
						remAttempts = 3;
						attempts = 0;
						List<String> menu = (rmt.buildMenuACL(username));
						Boolean exit = false;
						PrintServiceACL prnt = new PrintServiceACL();
							...
							try{
								...
								switch (option) {
						            ...
						            case 9:
						            	...
						            	System.out.println(prnt.setConfig(username,parameter, value));
						                break;
